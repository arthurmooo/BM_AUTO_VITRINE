...
const translations: Record<string, string> = {
  ...
  'Deux humains pour décider.': 'Two people to decide.',
  'Une équipe d’agents pour démultiplier l’exécution.': 'A team of agents to multiply execution.',
  'Arthur et Romuald donnent le cap, arbitrent et engagent BM Automation. Cinq agents spécialisés coordonnent, construisent, recherchent et contrôlent — chacun dans un périmètre clair.': 'Arthur and Romuald set the direction, make decisions and commit BM Automation. Five specialized agents coordinate, build, research and review — each within a clear scope.',
