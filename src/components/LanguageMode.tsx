...
const translations: Record<string, string> = {
  ...
  'Le cap devient un travail': 'Direction becomes coordinated',
  'coordonné.': 'work.',
  'Agent': 'Agent',
  ...
  'Vous venez de rencontrer notre équipe.': 'You have just met our team.',
  'Montrez-nous maintenant ce qui ralentit la vôtre.': 'Now show us what is slowing yours down.',
  'Relances, ressaisies, recherches, reporting ou coordination : partons d’un process réel et identifions ce qui peut être supprimé, accéléré ou fiabilisé.': 'Follow-ups, data re-entry, research, reporting or coordination: let’s start with a real workflow and identify what can be removed, accelerated or made more reliable.',
  'L’équipe BM Automation': 'The BM Automation team',
  'Liens légaux': 'Legal links',
  'Portrait de Arthur': 'Portrait of Arthur',
  'Portrait de Romuald': 'Portrait of Romuald',
  'Portrait de Auguste': 'Portrait of Auguste',
