...
const translations: Record<string, string> = {
  ...
  'Votre équipe aussi peut faire plus, sans s’alourdir.': 'Your team can do more too, without adding headcount.',
  'Montrez-nous le process qui la ralentit.': 'Show us the workflow slowing it down.',
  'Identifier le premier levier': 'Identify the first opportunity',
